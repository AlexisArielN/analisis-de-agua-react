...
import { subirImagenesMuestreo } from "../../service/muestreo-analisis/MuestreoService";

const MuestreoImagenesForm = () => {
  const { id } = useParams();
  ...
  const handleUpload = (e) => {
    ...
    subirImagenesMuestreo(id, selectedFiles)
      .then(() => {
        ...
        <Row className="mt-4">
          <Col>
            <Card>
              <Card.Body>
                <Card.Title>
                  <h2>Subir Imágenes para Muestreo #{id}</h2>
                </Card.Title>
...
export default MuestreoImagenesForm;
